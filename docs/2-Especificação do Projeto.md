...
| **Clayton Borges** |                     |                             | 
|------------------|---------------------|-----------------------------|
| ![Minha Imagem](index.md[https://raw.githubusercontent.com/ICEI-PUC-Minas-PPC-CC/ppc-cc-2024-2-ment2-noite1-program_acao_/main/docs/img/clarck.png.webp])) | **Idade:** 17 anos. **Naturalidade:** Belo Horizonte - Minas Gerais. **Ocupação:** Estudante. | **Atribuições:** Estudar no ensino médio e se tornar um grande empresário. |
